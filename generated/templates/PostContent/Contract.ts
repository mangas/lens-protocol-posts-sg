...
export class Contract__getProfileResultValue0Struct extends ethereum.Tuple {
  get pubCount(): BigInt {
...
export class Contract__getPubResultValue0Struct extends ethereum.Tuple {
  get profileIdPointed(): BigInt {
    return this[0].toBigInt();
  }
...
export class Contract__getPubPointerResult {
  value0: BigInt;
  value1: BigInt;
...
export class Contract__tokenDataOfResultValue0Struct extends ethereum.Tuple {
  get owner(): Address {
...
export class Contract extends ethereum.SmartContract {
  ...
  getProfile(profileId: BigInt): Contract__getProfileResultValue0Struct {
    let result = super.call(
      "getProfile",
    ...
    return changetype<Contract__getProfileResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_getProfile(
    profileId: BigInt
  ): ethereum.CallResult<Contract__getProfileResultValue0Struct> {
    let result = super.tryCall(
      "getProfile",
      "getProfile(uint256):((uint256,address,address,string,string,string))",
      [ethereum.Value.fromUnsignedBigInt(profileId)]
    ...
    return ethereum.CallResult.fromValue(
      changetype<Contract__getProfileResultValue0Struct>(value[0].toTuple())
    );
  }
  ...
  getPub(profileId: BigInt, pubId: BigInt): Contract__getPubResultValue0Struct {
    let result = super.call(
      "getPub",
    ...
    return changetype<Contract__getPubResultValue0Struct>(result[0].toTuple());
  }

  try_getPub(
    profileId: BigInt,
    pubId: BigInt
  ): ethereum.CallResult<Contract__getPubResultValue0Struct> {
    let result = super.tryCall(
      "getPub",
      "getPub(uint256,uint256):((uint256,uint256,string,address,address,address))",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<Contract__getPubResultValue0Struct>(value[0].toTuple())
    );
  }
  ...
  getPubPointer(
    ...
    return new Contract__getPubPointerResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_getPubPointer(
    profileId: BigInt,
    pubId: BigInt
  ): ethereum.CallResult<Contract__getPubPointerResult> {
    let result = super.tryCall(
      "getPubPointer",
      "getPubPointer(uint256,uint256):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Contract__getPubPointerResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  tokenDataOf(tokenId: BigInt): Contract__tokenDataOfResultValue0Struct {
    let result = super.call(
      "tokenDataOf",
    ...
    return changetype<Contract__tokenDataOfResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_tokenDataOf(
    tokenId: BigInt
  ): ethereum.CallResult<Contract__tokenDataOfResultValue0Struct> {
    let result = super.tryCall(
      "tokenDataOf",
      "tokenDataOf(uint256):((address,uint96))",
      [ethereum.Value.fromUnsignedBigInt(tokenId)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<Contract__tokenDataOfResultValue0Struct>(value[0].toTuple())
    );
  }
